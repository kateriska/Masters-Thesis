...
def parse_args():
    ...
    argParser.add_argument('--model', dest='model', action='store', default="ssd_mobilenet_v2", choices=['ssd_mobilenet_v2', 'faster_rcnn_resnet50', 'faster_rcnn_resnet101', 'ssd_resnet50', 'ssd_mobilenet_v1', 'faster_rcnn_nas'], help='Select type of model.')
