...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=260px]{obrazky-figures/kuze.jpeg}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=380px]{obrazky-figures/zpracovani_otisku.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=210px]{obrazky-figures/typy.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=190px]{obrazky-figures/tridy.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=260px]{obrazky-figures/dakt_karta.png}
...
\begin{figure}[!htbp]
  \begin{minipage}[b]{0.3\linewidth}
    \centering
    \includegraphics[width=70px]{obrazky-figures/SG1_1.png}
    \caption{Syntetický otisk prstu vygenerovaný generátorem SFinGe}
  \end{minipage}
  \hspace{0.5cm}
  \begin{minipage}[b]{0.3\linewidth}
    \centering
    \includegraphics[width=70px]{obrazky-figures/SG1_1_warts.png}
    \caption{Generované onemocnění bradavice do~syntetického otisku prstu}
  \end{minipage}
  \hspace{0.5cm}
  \begin{minipage}[b]{0.3\linewidth}
    \centering
    \includegraphics[width=60px]{obrazky-figures/SG10_1.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=410px]{obrazky-figures/sigmoid.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=300px]{obrazky-figures/vgg16.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=360px]{obrazky-figures/rcnn.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=210px]{obrazky-figures/fasterrcnn.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=280px]{obrazky-figures/ssd_feature_map.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=350px]{obrazky-figures/ssd_architecture.png}
