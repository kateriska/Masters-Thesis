...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=260px]{obrazky-figures/bio_system.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=280px]{obrazky-figures/kuze.jpeg}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=100px]{obrazky-figures/zdravyotisk.PNG}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=400px]{obrazky-figures/zpracovani_otisku.png}
...
Pro extrakci markantů je nutné následně \textbf{ztenčit papilární linie} na šířku 1 pixelu. V~tomto případu je nutné, aby algoritmus ztenčování byl všesměrový, kdy v žádném směru nesmí ubývat papilární linie. Jednou z vhodných metod je Metoda Emyroglu, která používá dva typy bodů -- RMP (Ridge Meeting Point) a RCP (Ridge Continuity Point) \cite{BIOopora}.
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=320px]{obrazky-figures/typy.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=220px]{obrazky-figures/markanty.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=210px]{obrazky-figures/tridy.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=380px]{obrazky-figures/dakt_karta.png}
...
\begin{figure}[!htbp]
  \begin{minipage}[b]{0.3\linewidth}
    \centering
    \includegraphics[width=120px]{obrazky-figures/SG1_1.png}
  ...
  \begin{minipage}[b]{0.3\linewidth}
    \centering
    \includegraphics[width=110px]{obrazky-figures/SG1_1_warts.png}
  ...
  \begin{minipage}[b]{0.3\linewidth}
    \centering
    \includegraphics[width=100px]{obrazky-figures/SG10_1.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=190px]{obrazky-figures/umely_neuron.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=200px]{obrazky-figures/perceptron.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=450px]{obrazky-figures/sigmoid.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=320px]{obrazky-figures/vgg16.png}
...
\begin{figure}[!htbp]
  \begin{minipage}[b]{0.5\linewidth}
    \centering
    \includegraphics[width=230px]{obrazky-figures/depthwise.png}
  ...
  \begin{minipage}[b]{0.5\linewidth}
    \centering
    \includegraphics[width=230px]{obrazky-figures/depthwise2.png.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=350px]{obrazky-figures/rcnn.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=300px]{obrazky-figures/fastrcnn.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=180px]{obrazky-figures/fasterrcnn.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=300px]{obrazky-figures/ssd_feature_map.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=420px]{obrazky-figures/ssd_architecture.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=450px]{obrazky-figures/centerNet.png}
...
\iffalse
EfficientDet je modelem vyvinutým společností Google v roce 2020. Díky svému nízkému počtu parametrů se řadí k sítím s nižšími nároky na výpočetní zdroje a vyšší rychlostí trénování. Pro páteřní síť není užita např. MobileNet nebo ResNet-50 jako u předchozích metod, ale opět společností Google vyvinutá síť EfficientNet. EfficientDet neužívá FPN (Feature Pyramid Network) jako běžné algoritmy pro detekci. Při užití FPN jsou všechny rysy různých rozlišení posuzovány stejným způsobem a je jim tedy přikládána totožná důležitost. FPN je nahrazeno BiFPN (Weighted Bi-directional Feature Pyramid Network), který umožňuje analýzu a získání pouze důležitých rysů. Architektura modelu EfficientDet je znázorněna na obrázku \ref{fig:efficientdet}.



Pokud chceme dosáhnout vyšší přesnosti modelu, je běžným způsobem škálovat model za pomoci využití větší páteřní sítě nebo zvětšením rozlišení vstupního obrázku. Autoři však tento problém vyřešili jinak a navrhli heuristickou metodu pro složené škálování modelu. Každá z komponent sítě -- páteřní síť EfficientNet, BiFPN a síť pro detekci bounding boxu a predikci třídy objektu -- má jeden ze složených faktorů škálování. Můžeme provést např. následující typy škálování:
\begin{itemize}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=450px]{obrazky-figures/efficientDet.png}
